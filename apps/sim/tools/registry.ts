...
import {
  microsoftCalendarAcceptEventTool,
  microsoftCalendarCreateCalendarTool,
  microsoftCalendarCreateEventTool,
  microsoftCalendarDeclineEventTool,
  microsoftCalendarDeleteCalendarTool,
  microsoftCalendarDeleteEventTool,
  microsoftCalendarForwardEventTool,
  microsoftCalendarGetCalendarTool,
  microsoftCalendarGetEventTool,
  microsoftCalendarListCalendarsTool,
  microsoftCalendarListEventsTool,
  microsoftCalendarTentativelyAcceptEventTool,
  microsoftCalendarUpdateCalendarTool,
  microsoftCalendarUpdateEventTool,
} from '@/tools/microsoft_calendar'
import {
...
import {
  microsoftOnenoteAppendToPageTool,
  microsoftOnenoteCopyPage,
  microsoftOnenoteCreateNotebookTool,
  microsoftOnenoteCreatePageTool,
  microsoftOnenoteCreateSectionGroup,
  microsoftOnenoteCreateSectionTool,
  microsoftOnenoteDeletePageTool,
  microsoftOnenoteGetNotebookTool,
  microsoftOnenoteGetPageContent,
  microsoftOnenoteGetPagesDelta,
  microsoftOnenoteGetPageTool,
  microsoftOnenoteGetResource,
  microsoftOnenoteGetSectionGroup,
  microsoftOnenoteGetSectionTool,
  microsoftOnenoteListNotebooksTool,
  microsoftOnenoteListPagesTool,
  microsoftOnenoteListResources,
  microsoftOnenoteListSectionGroups,
  microsoftOnenoteListSectionsTool,
  microsoftOnenoteSearchPagesTool,
  microsoftOnenoteUpdatePageTool,
} from '@/tools/microsoft_onenote'
import {
...
import {
  webexCreateMeetingTool,
  webexCreateRoomTool,
  webexDeleteMeetingTool,
  webexDeleteMessageTool,
  webexGetMeetingTool,
  webexGetMessageTool,
  webexGetPersonTool,
  webexGetRoomTool,
  webexListMeetingsTool,
  webexListMembersTool,
  webexListMessagesTool,
  webexListRoomsTool,
  webexSendMessageTool,
  webexUpdateMeetingTool,
} from '@/tools/webex'
import {
...
export const tools: Record<string, ToolConfig> = {
  ...
  webex_send_message: webexSendMessageTool,
  webex_list_messages: webexListMessagesTool,
  webex_get_message: webexGetMessageTool,
  webex_delete_message: webexDeleteMessageTool,
  webex_list_rooms: webexListRoomsTool,
  webex_create_room: webexCreateRoomTool,
  webex_get_room: webexGetRoomTool,
  webex_list_members: webexListMembersTool,
  webex_get_person: webexGetPersonTool,
  webex_create_meeting: webexCreateMeetingTool,
  webex_list_meetings: webexListMeetingsTool,
  webex_get_meeting: webexGetMeetingTool,
  webex_update_meeting: webexUpdateMeetingTool,
  webex_delete_meeting: webexDeleteMeetingTool,
  x_write: xWriteTool,
  x_read: xReadTool,
  ...
  json_helper_parse: jsonParseTool,
  json_helper_stringify: jsonStringifyTool,
  json_helper_get: jsonGetTool,
  json_helper_set: jsonSetTool,
  json_helper_delete: jsonDeleteKeyTool,
  json_helper_merge: jsonMergeTool,
  json_helper_flatten: jsonFlattenTool,
  json_helper_keys: jsonKeysTool,
  json_helper_values: jsonValuesTool,
  json_helper_entries: jsonEntriesTool,
  json_helper_filter_keys: jsonFilterKeysTool,
  json_helper_array_get: jsonArrayGetTool,
  json_helper_array_filter: jsonArrayFilterTool,
  json_helper_array_map: jsonArrayMapTool,
  json_helper_size: jsonSizeTool,
  json_helper_type_check: jsonTypeCheckTool,
  ...
  microsoft_todo_list_task_lists: listTaskListsTool,
  microsoft_todo_get_task_list: getTaskListTool,
  microsoft_todo_create_task_list: createTaskListTool,
  microsoft_todo_update_task_list: updateTaskListTool,
  microsoft_todo_delete_task_list: deleteTaskListTool,
  microsoft_todo_list_tasks: listTasksTool,
  microsoft_todo_get_task: getTaskTool,
  microsoft_todo_create_task: createTaskTool,
  microsoft_todo_update_task: updateTaskTool,
  microsoft_todo_delete_task: deleteTaskTool,
  microsoft_todo_complete_task: completeTaskTool,
  microsoft_todo_reopen_task: reopenTaskTool,
  microsoft_todo_list_checklist_items: listChecklistItemsTool,
  microsoft_todo_create_checklist_item: createChecklistItemTool,
  microsoft_todo_update_checklist_item: updateChecklistItemTool,
  microsoft_todo_delete_checklist_item: deleteChecklistItemTool,
  microsoft_todo_list_attachments: listAttachmentsTool,
  microsoft_todo_get_attachment: getAttachmentTool,
  microsoft_todo_add_attachment: addAttachmentTool,
  microsoft_todo_delete_attachment: deleteAttachmentTool,
  ...
  microsoft_calendar_list_calendars: microsoftCalendarListCalendarsTool,
  microsoft_calendar_get_calendar: microsoftCalendarGetCalendarTool,
  microsoft_calendar_create_calendar: microsoftCalendarCreateCalendarTool,
  microsoft_calendar_update_calendar: microsoftCalendarUpdateCalendarTool,
  microsoft_calendar_delete_calendar: microsoftCalendarDeleteCalendarTool,
  microsoft_calendar_list_events: microsoftCalendarListEventsTool,
  microsoft_calendar_get_event: microsoftCalendarGetEventTool,
  microsoft_calendar_create_event: microsoftCalendarCreateEventTool,
  microsoft_calendar_update_event: microsoftCalendarUpdateEventTool,
  microsoft_calendar_delete_event: microsoftCalendarDeleteEventTool,
  microsoft_calendar_accept_event: microsoftCalendarAcceptEventTool,
  microsoft_calendar_decline_event: microsoftCalendarDeclineEventTool,
  microsoft_calendar_tentatively_accept_event: microsoftCalendarTentativelyAcceptEventTool,
  microsoft_calendar_forward_event: microsoftCalendarForwardEventTool,
  microsoft_onenote_list_notebooks: microsoftOnenoteListNotebooksTool,
  microsoft_onenote_get_notebook: microsoftOnenoteGetNotebookTool,
  microsoft_onenote_create_notebook: microsoftOnenoteCreateNotebookTool,
  microsoft_onenote_list_sections: microsoftOnenoteListSectionsTool,
  microsoft_onenote_get_section: microsoftOnenoteGetSectionTool,
  microsoft_onenote_create_section: microsoftOnenoteCreateSectionTool,
  microsoft_onenote_list_section_groups: microsoftOnenoteListSectionGroups,
  microsoft_onenote_get_section_group: microsoftOnenoteGetSectionGroup,
  microsoft_onenote_create_section_group: microsoftOnenoteCreateSectionGroup,
  microsoft_onenote_list_pages: microsoftOnenoteListPagesTool,
  microsoft_onenote_get_page: microsoftOnenoteGetPageTool,
  microsoft_onenote_get_page_content: microsoftOnenoteGetPageContent,
  microsoft_onenote_create_page: microsoftOnenoteCreatePageTool,
  microsoft_onenote_update_page: microsoftOnenoteUpdatePageTool,
  microsoft_onenote_delete_page: microsoftOnenoteDeletePageTool,
  microsoft_onenote_append_to_page: microsoftOnenoteAppendToPageTool,
  microsoft_onenote_copy_page: microsoftOnenoteCopyPage,
  microsoft_onenote_search_pages: microsoftOnenoteSearchPagesTool,
  microsoft_onenote_list_resources: microsoftOnenoteListResources,
  microsoft_onenote_get_resource: microsoftOnenoteGetResource,
  microsoft_onenote_get_pages_delta: microsoftOnenoteGetPagesDelta,
